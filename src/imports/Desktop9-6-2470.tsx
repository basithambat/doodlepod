import svgPaths from "./svg-3lc0kclws2";

export default function Desktop() {
  return (
    <div className="bg-[#f5e88c] content-stretch flex gap-[64px] items-start justify-center pb-[120px] pt-[88px] px-[269px] relative size-full" data-name="Desktop - 9">
      <div className="content-stretch flex flex-col gap-[64px] items-center relative shrink-0">
        <div className="content-stretch flex flex-col gap-[24px] items-start relative shrink-0 w-full">
          <p className="font-['Google_Sans:Medium',sans-serif] font-medium leading-[normal] relative shrink-0 text-[#0256da] text-[28px] w-full" style={{ fontVariationSettings: "'GRAD' 0" }}>
            for parents
          </p>
          <p className="font-['Recoleta_Alt:Bold',sans-serif] leading-[64px] not-italic relative shrink-0 text-[#131415] text-[56px] w-full">built for kids. designed for parent peace of mind.</p>
          <p className="font-['Google_Sans:Medium',sans-serif] font-medium leading-[normal] relative shrink-0 text-[#131415] text-[28px] w-full" style={{ fontVariationSettings: "'GRAD' 0" }}>
        ...
        <div className="content-stretch flex flex-col gap-[16px] items-start relative shrink-0">
          <div className="h-[57px] overflow-clip relative shrink-0 w-[547px]" data-name="Frame">
            ...
            <p className="absolute font-['Google_Sans:Bold',sans-serif] font-bold inset-[23.6%_3.75%_23.77%_3.2%] leading-[normal] text-[#e9e7e0] text-[24px] whitespace-nowrap" style={{ fontVariationSettings: "'GRAD' 0" }}>
          ...
          <div className="h-[57px] overflow-clip relative shrink-0 w-[523px]" data-name="Frame">
            ...
            <p className="absolute font-['Google_Sans:Bold',sans-serif] font-bold inset-[23.6%_3.9%_23.77%_3.36%] leading-[normal] text-[#e9e7e0] text-[24px] whitespace-nowrap" style={{ fontVariationSettings: "'GRAD' 0" }}>
          ...
          <div className="h-[57px] overflow-clip relative shrink-0 w-[517px]" data-name="Frame">
            ...
            <p className="absolute font-['Google_Sans:Bold',sans-serif] font-bold inset-[23.6%_4.01%_23.77%_3.34%] leading-[normal] text-[#e9e7e0] text-[24px] whitespace-nowrap" style={{ fontVariationSettings: "'GRAD' 0" }}>
          ...
          <div className="h-[57px] overflow-clip relative shrink-0 w-[421px]" data-name="Frame">
            ...
            <p className="absolute font-['Google_Sans:Bold',sans-serif] font-bold inset-[23.25%_4.82%_24.12%_4.2%] leading-[normal] text-[#e9e7e0] text-[24px] whitespace-nowrap" style={{ fontVariationSettings: "'GRAD' 0" }}>
          ...
          <div className="h-[57px] overflow-clip relative shrink-0 w-[515px]" data-name="Frame">
            ...
            <p className="absolute font-['Google_Sans:Bold',sans-serif] font-bold inset-[23.6%_3.83%_23.77%_3.55%] leading-[normal] text-[#e9e7e0] text-[24px] whitespace-nowrap" style={{ fontVariationSettings: "'GRAD' 0" }}>
      ...
      <div className="content-stretch flex flex-col gap-[64px] items-start relative shrink-0 w-[490px]">
        <div className="content-stretch flex flex-col gap-[24px] items-start relative shrink-0 w-full">
          <p className="font-['Google_Sans:Medium',sans-serif] font-medium leading-[normal] relative shrink-0 text-[#c65772] text-[28px] w-full" style={{ fontVariationSettings: "'GRAD' 0" }}>
            For kids
          </p>
          <p className="font-['Recoleta_Alt:Bold',sans-serif] leading-[64px] not-italic relative shrink-0 text-[#131415] text-[56px] w-full">a little box for big imagination</p>
          <p className="font-['Google_Sans:Medium',sans-serif] font-medium leading-[normal] relative shrink-0 text-[#131415] text-[28px] w-full" style={{ fontVariationSettings: "'GRAD' 0" }}>
        ...
        <div className="content-start flex flex-wrap gap-[32px] items-start relative shrink-0 w-full">
          <div className="h-[56px] overflow-clip relative shrink-0 w-[182px]" data-name="Frame">
            <div className="absolute inset-[8.04%_2.22%_6.25%_1.08%]" data-name="Vector">
              <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 176 48">
                <path d={svgPaths.p22b338f0} fill="var(--fill-0, #FF9EB5)" id="Vector" />
              </svg>
            </div>
            <div className="absolute inset-[-0.89%_0.02%_-0.89%_-0.02%]" data-name="Mask group">
              <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 182 57">
                <g id="Mask group">
                  <mask height="57" id="mask0_6_1249" maskUnits="userSpaceOnUse" style={{ maskType: "luminance" }} width="182" x="0" y="0">
                    <g id="Group">
                      <path d="M182 0H0V57H182V0Z" fill="var(--fill-0, white)" id="Vector" />
                      <path d={svgPaths.p1208ba00} fill="var(--fill-0, black)" id="Vector_2" />
                    </g>
                  </mask>
                  <g mask="url(#mask0_6_1249)">
                    <path d={svgPaths.p3e0dba80} fill="var(--fill-0, black)" id="Vector_3" />
                  </g>
                </g>
              </svg>
            </div>
            <p className="absolute font-['Google_Sans:Bold',sans-serif] font-bold inset-[14.82%_10.84%_13.75%_10.04%] leading-[normal] text-[32px] text-black text-center whitespace-nowrap" style={{ fontVariationSettings: "'GRAD' 0" }}>
              Monsters
            </p>
          </div>
